...
public class Edit extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {super.onCreate(savedInstanceState);
        ...
        edEditJudulBuku = (EditText) findViewById(R.id.edEditJudulBuku);
        edEditNamaPengarang = (EditText)
                findViewById(R.id.edEditNamaPengarang);
        edEditTahunTerbit = (EditText) findViewById(R.id.edEditTahunTerbit);
        edEditPenerbit = (EditText) findViewById(R.id.edEditPenerbit);
        ...
        if (cursor.getCount()>0)
        {
            ...
            edEditJudulBuku.setText(cursor.getString(1).toString());
            edEditNamaPengarang.setText(cursor.getString(2).toString());
            edEditTahunTerbit.setText(cursor.getString(3).toString());
            edEditPenerbit.setText(cursor.getString(4).toString());
        }
